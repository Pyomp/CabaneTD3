...
export class Cerbere extends Enemy_Abstract {
    /**
     * @param {Vector3} pos
    ...
    constructor(
        ...
        super(
            pos,
            bosses_design.cerbere,
            max_hp_manager.cerbere,
            loop_manager,
            physics,
            user_data,
            enemy_manager,
        ...
        this.on_state.add(() => {
            if (this.state === 'die') {
                loot_system.loot(this.position)
                return true
            }
        })

        Cerbere.on_create?.(this)
    }
}