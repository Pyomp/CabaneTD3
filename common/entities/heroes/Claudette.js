...
export class Claudette extends Hero_Abstract {
    /**
     * 
     * @param {Vector3} pos
    ...
    constructor(
        ...
        const user = user_data.heroes.claudette
        ...
        const on_attack_collision = (target) => {
            damage_system.hero_damage(user, 'claudette', target)
        }
        const attack = () => {
            new Paw(
                from_attack(),
