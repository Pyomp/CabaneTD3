...
export class Cyan extends Hero_Abstract {
    /**
     * 
     * @param {Vector3} pos
    ...
    constructor(
        ...
        const user = user_data.heroes.cyan
        ...
        const on_attack_collision = (target) => {
            damage_system.hero_damage(user, 'cyan', target)
        }
        ...
        const on_ult_collision = () => {
            damage_system.hero_damage_all(user, 'cyan')
        }
