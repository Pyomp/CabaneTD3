...
export class Green extends Hero_Abstract {
    /**
     * 
     * @param {Vector3} pos
    ...
    constructor(
        ...
        const user = user_data.heroes.green
        ...
        const on_attack_collision = (target) => {
            damage_system.hero_damage(user, 'green', target)
        }
        ...
        const on_ult_collision = () => {
            damage_system.hero_damage_all(user, 'green')
        }
