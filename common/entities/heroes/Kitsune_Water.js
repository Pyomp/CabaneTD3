...
export class Kitsune_Water extends Hero_Abstract {
    ...
    constructor(
        ...
        const user = user_data.heroes.kitsune_water
        ...
        const on_attack_collision = (target) => {
            damage_system.hero_damage(user, 'kitsune_water', target)
        }
        ...
        const on_ult_collision = () => {
            damage_system.hero_damage_all(user, 'kitsune_water')
        }
