import { ITEM_ARROW_PENETRATION } from '../../../game_design/items/item_design_constants.js'
...
export class Arrow extends Item_Interface {
    constructor(
       ...
       /** @type {Loop_Manager} */ loop_manager,
        ...
        super(position, new Item_Data(ITEM_ARROW_PENETRATION, rank), bag_data, loop_manager)
    }
}
