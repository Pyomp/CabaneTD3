import { ITEM_AXE } from '../../../game_design/items/item_design_constants.js'
...
export class Axe extends Item_Interface {
    constructor(
       ...
       /** @type {Loop_Manager} */ loop_manager,
        ...
        super(position, new Item_Data(ITEM_AXE, rank), bag_data, loop_manager)
    }
}
