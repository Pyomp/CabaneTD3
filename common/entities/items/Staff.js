import { ITEM_STAFF } from '../../../game_design/items/item_design_constants.js'
...
export class Staff extends Item_Interface {
    constructor(
       ...
       /** @type {Loop_Manager} */ loop_manager,
        ...
        super(position, new Item_Data(ITEM_STAFF, rank), bag_data, loop_manager)
    }
}
