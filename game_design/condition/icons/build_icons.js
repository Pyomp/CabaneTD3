...
export const ${nameF}SVG = ()=>{return createSVGElement(${nameF}RAW)}
export const ${nameF}IMG = (width, height)=>{return svgToImg(${nameF}RAW, width, height)}
export const ${nameF}CANVAS = (width, height)=>{return svgToCanvas(${nameF}RAW, width, height)}
`
